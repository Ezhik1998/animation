...
let modulePaths = {
 ...
 "packages/diagramm/01": "packages/diagramm/01.ddc",
 "packages/diagramm/01_web_entrypoint": "packages/diagramm/01_web_entrypoint.ddc",
...
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + '01_web_entrypoint.digests',
...
define("01_web_entrypoint.dart.bootstrap", ["packages/diagramm/01_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.lib__01_web_entrypoint || app.$01_web_entrypoint).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:diagramm/01_web_entrypoint.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("01_web_entrypoint.dart.bootstrap", {
    "01_web_entrypoint.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
