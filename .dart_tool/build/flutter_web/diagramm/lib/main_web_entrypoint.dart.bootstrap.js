...
let modulePaths = {
 ...
 "packages/diagramm/main": "packages/diagramm/main.ddc",
 "packages/diagramm/main_web_entrypoint": "packages/diagramm/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/diagramm/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:diagramm/main_web_entrypoint.dart") {
          // Clear static caches.
