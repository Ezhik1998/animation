define(['dart_sdk', 'packages/diagramm/main'], function(dart_sdk, packages__diagramm__main) {
  'use strict';
  ...
  const main = packages__diagramm__main.main;
  ...
  dart.trackLibraries("packages/diagramm/main_web_entrypoint", {
    "package:diagramm/main_web_entrypoint.dart": main_web_entrypoint
  }, {
